...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          path: '/regestration',
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'Regestration')
              : const RegestrationWidget(),
        ),
        FFRoute(
          name: 'walletTransaction',
          path: '/walletTransaction',
          builder: (context, params) => WalletTransactionWidget(
            classid: params.getParam(
              'classid',
              ParamType.int,
            ),
        ...
        FFRoute(
          ...
          path: '/whatsappConfirm',
          builder: (context, params) => WhatsappConfirmWidget(
        ...
        FFRoute(
          name: 'chooseStudent',
          path: '/chooseStudent',
          builder: (context, params) => const ChooseStudentWidget(),
        ),
        FFRoute(
